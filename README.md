...
This repository contains the source code and experiments conducted for our Engineer's thesis on generating Python code using transformer models (specifically based on the T5 architecture).
